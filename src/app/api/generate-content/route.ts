...
const nosousWordCounts: Record<Difficulty, string> = {
  سهل: '250-400 كلمة على الأقل - نص أدبي واضح بأسلوب جميل',
  متوسط: '400-650 كلمة على الأقل - نص أدبي عميق بصور بيانية وطبقات معنوية',
  صعب: '600-900 كلمة على الأقل - نص أدبي مركّب كثيف الصور والرموز والإيحاءات',
}
...
const nosousDifficultyInstructions: Record<Difficulty, string> = {
  سهل: `مستوى سهل:
- نص أدبي واضح الأسلوب، قريب الإحساس، مباشر الصور
- أسئلة مباشرة عن الصور البيانية والأساليب: الإجابة تُستنتج بسهولة من النص
- الخيارات واضحة الفرق
- مثال: "ما نوع الصورة البيانية في قول الكاتب...؟" والإجابة مباشرة
- اجعل النص يشبه قطعة أدبية مكتوبة بعناية لطلاب المرحلة الثانوية`,

  متوسط: `مستوى متوسط:
- نص أدبي أعمق، أشد رمزية، أغنى بلاغة
- أسئلة تتطلب فهماً أدبياً وتذوقاً: الإجابة مش مباشرة وتحتاج تحليل
- الخيارات متقاربة جداً: تحتاج فهم بلاغي دقيق لتمييز الصحيح
...
أجب بصيغة JSON فقط:
{
  ...
  const wordCounts: Record<Difficulty, string> = {
    سهل: '300-450 كلمة على الأقل - نص غني مفصّل مع أمثلة وتوضيح طبيعي',
    متوسط: '450-650 كلمة على الأقل - نص عميق متعدد الأفكار والزوايا مع حجج وتفاصيل ممتعة',
    صعب: '600-850 كلمة على الأقل - نص مركّب كثيف الأفكار متعدد الطبقات والاستنتاجات مع تراكب المفاهيم',
  }
...
- النص لازم يكون مكتوب بأسلوب سلس وبسيط بس غني بالمعاني والأمثلة الواضحة
- استخدم فقرات قصيرة وواضحة مع أمثلة ملموسة تساعد القارئ يفهم بسهولة
...
- اعرض وجهات نظر متعددة قبل ما تخلص لرأي أو نتيجة
...
1. اكتب نصاً عربياً أصلياً طويلاً وغنياً بالمعلومات والتفاصيل (غير منسوخ من أي مكان). يجب أن يكون النص:
   - مستوى "سهل": 300-450 كلمة على الأقل - نص غني مفصّل مع أمثلة وتوضيح طبيعي
   - مستوى "متوسط": 450-650 كلمة على الأقل - نص عميق متعدد الأفكار والزوايا مع حجج وتفاصيل ممتعة
   - مستوى "صعب": 600-850 كلمة على الأقل - نص مركّب كثيف الأفكار متعدد الطبقات والاستنتاجات مع تراكب المفاهيم
